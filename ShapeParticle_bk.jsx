...
(function() {
    ...
    // Add live update checkbox
    var liveUpdateGroup = basicTab.add("group");
    liveUpdateGroup.orientation = "row";
    liveUpdateGroup.alignChildren = ["left", "center"];
    var liveUpdateCheckbox = liveUpdateGroup.add("checkbox", undefined, "Live Update");
    ...
    velocityDirText.onChange = handleLiveUpdate;
    ...
    gravityDirText.onChange = handleLiveUpdate;
    ...
    systemDropdown.onChange = function() {
        if (systemDropdown.selection.index > 0) {
            ...
            updateControlFromSettings("Velocity Direction", null, velocityDirText, true);
            ...
            updateControlFromSettings("Gravity Direction", null, gravityDirText, true);
    ...
    function updateControlFromSettings(settingName, slider, textField, isAngle, formatFunc, formatParam) {
        if (loadedSettings && loadedSettings.hasOwnProperty(settingName)) {
            ...
            if (textField) {
                if (formatFunc === "toFixed" && formatParam !== undefined) {
    ...
    function resetControlsToDefaults() {
        // Physics controls
        velocitySlider.value = velocityText.text = 100;
        velocityVarSlider.value = velocityVarText.text = 50;
        velocityDirText.text = "0";
        velocityDirVarSlider.value = velocityDirVarText.text = 10;
        gravitySlider.value = gravityText.text = 98;
        gravityDirText.text = "180";
        resistanceSlider.value = resistanceText.text = 0;
        lifetimeSlider.value = 4; lifetimeText.text = "4.0";
        emitterWidthSlider.value = emitterWidthText.text = 0;
        emitterHeightSlider.value = emitterHeightText.text = 0;
        
        // Appearance controls
        particleSizeSlider.value = particleSizeText.text = 10;
        sizeVarSlider.value = sizeVarText.text = 5;
        colorVarSlider.value = colorVarText.text = 0;
        colorOffsetSlider.value = colorOffsetText.text = 20;
        maxOpacitySlider.value = maxOpacityText.text = 100;
        opacityVarSlider.value = opacityVarText.text = 20;
        fadeInSlider.value = fadeInText.text = 10;
        fadeOutSlider.value = fadeOutText.text = 80;
        rotSpeedSlider.value = rotSpeedText.text = 0;
        rotSpeedVarSlider.value = rotSpeedVarText.text = 0;
        rotVarSlider.value = rotVarText.text = 180;
        turbAmountSlider.value = turbAmountText.text = 40;
        turbSpeedSlider.value = 1; turbSpeedText.text = "1.0";
...
sliderProperty.maximum = 32;
    ...
    var rotSpeedVarSlider = rotSpeedVarGroup.add("slider", undefined, 0, 0, 360);
    ...
    startColorButton.onClick = function() {
        // Cannot directly access color picker in ScriptUI, but notify user
        alert("To change colors, select the particle system control layer (SP-ctrl) in your composition and modify the Start Color and End Color effects.");
    };
